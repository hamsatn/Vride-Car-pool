...
Car code :<input class="tes" type="text" name= code id="para" /><br><br>
Car name:<input class="tes" type="text" name=name id="para1" /><br><br>
Capacity:<input type="text" name=capacity  class="tes"/><br><br>
